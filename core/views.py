...
class SearchResultsComputer(ListView):
    ...
    def get_queryset(self):
        object_list = Item.objects.filter(
            Q(description__icontains='computer') | Q(description__icontains='computers') | Q(description__icontains='COMPUTER') 
            )
        return object_list
...
class SearchResultsLaptop(ListView):
    ...
    def get_queryset(self):
        object_list = Item.objects.filter(
            Q(description__icontains='laptop') | Q(description__icontains='Laptops') | Q(description__icontains='LAPTOP') | Q(description__icontains='Laptop')
            )
        return object_list